...
**学号**：23011120130、23011120121、23011120110、21011120223
...
1. 李煜玺：负责从自选文本构建训练语料，完成文本清洗与分词处理（30%）
2. 邓明勇：负责 Word2Vec 模型构建与训练（25%）
3. 范乂：负责模型验证与词向量分析，包括词向量提取、相似度计算、最相似词查询（25%）
4. 赵天保：负责实验报告撰写、结果表格整理及训练损失可视化（20%）
